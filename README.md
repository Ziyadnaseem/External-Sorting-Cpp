...
? Example format: If your input file is at ./data/input.txt and if you need your output file at ./data/ named output.txt, your code should accept two arguments ./a.out “./data/input.txt” “./data/output.txt”
</br>
**Output:** A file containing non-Descending sorted list of the given integers.
</br>
To generate an unsorted file:
